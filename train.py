...
class PrecomputedDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        self.embeddings_data_module = EmbeddingsDataModule(
            ...
            train_semipositives_path=getattr(self, 'train_semipositives_path', None),
            val_semipositives_path=getattr(self, 'val_semipositives_path', None)
        )
...
def parse_args():
    ...
    parser.add_argument("--train_semipositives_path", type=str, default=None,
                        help="Path to training semi-positives file")
    parser.add_argument("--val_semipositives_path", type=str, default=None,
                        help="Path to validation semi-positives file")
...
def main():
    ...
    if args.use_precomputed:
        ...
        data_module = PrecomputedDataModule(
            ...
            train_semipositives_path=args.train_semipositives_path,
            val_semipositives_path=args.val_semipositives_path,
        )
    else:
